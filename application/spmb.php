...
$allowed_roles = array(1, 16); // Sesuaikan dengan peran yang diizinkan untuk siam.php
    ...
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6 text-center">
                <h1 class="mb-4">SPMB - Seleksi Penerimaan Mahasiswa Baru</h1>
                <p class="lead">Merupakan Sistem informasi yang khusus digunakan oleh panitia penerimaan mahasiswa baru dalam rangkaian kegiatan PMB Online. </p>
                <p class="lead">Pengguna : Panitia PMB</p>
            </div>
        </div>
    </div>

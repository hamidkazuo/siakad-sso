...
$allowed_roles = array(1, 7, 9, 10); // Sesuaikan dengan peran yang diizinkan untuk sirak.php
    ...
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6 text-center">
                <h1 class="mb-4">SIKU - Sistem Informasi Keuangan</h1>
                <p class="lead">Merupakan layanan akademik yang dikhususkan pada bidang pengelolaan keuangan berkaitan dengan kegiatan akademik yang melibatkan mahasiswa dosen serta elemen terkait.</p>
                <p class="lead">Pengguna : BAU, Bag.Keuangan, Bendahara</p>
            </div>
        </div>
    </div>

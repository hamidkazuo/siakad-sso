...
$allowed_roles = array(1, 7, 18); // Sesuaikan dengan peran yang diizinkan untuk sirak.php
...
<head>
    ...
    <title>SIDA - Sistem Informasi Wisuda</title>
    ...
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6 text-center">
                <h1 class="mb-4">SIDA - Sistem Informasi Wisuda</h1>
                <p class="lead">Sistem Informasi penyelenggaraan kegiatan serta penyelenggaraan yudisium dan Wisuda.</p>
                <p class="lead">Pengguna : Panitia Wisuda dan Yudisium</p>
            </div>
        </div>
    </div>
